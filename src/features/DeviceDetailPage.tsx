...
export function DeviceDetailPage() {
  ...
  useEffect(() => {
    void networkService.device(id).then(setDevice).catch((cause) => setError(cause instanceof Error ? cause.message : "Device data is unavailable."));
  }, [id]);

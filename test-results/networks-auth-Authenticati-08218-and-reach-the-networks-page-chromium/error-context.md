...
- Name: networks-auth.spec.ts >> Authentication and networks access >> should log in with an existing account and reach the networks page
- Location: tests\networks-auth.spec.ts:74:3
